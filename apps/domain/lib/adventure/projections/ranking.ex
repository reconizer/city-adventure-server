defmodule Domain.Adventure.Projections.Ranking do
  ...
  def get_ranking_for_adventure(%{page: page, limit: limit, id: adventure_id}, %{id: owner_id}) do
    result =
      ranking_query(adventure_id, owner_id)
      |> paginate(page, limit)
      |> Repository.all()
  ...
  def top_ten_ranking(%{id: adventure_id}, %{id: owner_id}) do
    result =
      ranking_query(adventure_id, owner_id)
      |> limit(11)
      |> Repository.all()
  ...
  defp ranking_query(adventure_id, owner_id) do
    from(
      user_ranking in Models.UserRanking,
