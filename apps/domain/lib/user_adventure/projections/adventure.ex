defmodule Domain.UserAdventure.Projections.Adventure do
  ...
  defstruct [:id, :description, :min_time, :max_time, :difficulty_level, :language, :name, :rating_count, :creator_id, :rating, :author_name, :author_id,:owner_rating, author_asset: %{}, owner_ranking: %{}, asset: %{}, images: [], top_five: []]
  ...
  defp get_creator(%Adventure{} = adventure) do
    ...
    |> Repository.one()
    |> case do
      nil -> {:error, {:creator, "not_found"}}
      result -> 
        adventure_update = adventure
