defmodule UserApiWeb.RankingControllerTest do
  ...
  setup do
    ...
    insert(:ranking, adventure: adventure, user: user_6, completion_time: 6700)
    insert(:ranking, adventure: adventure, user: user_5, completion_time: 6450)
    insert(:ranking, adventure: adventure, user: user_4, completion_time: 6720)
    insert(:ranking, adventure: adventure, user: user_3, completion_time: 6800)
    insert(:ranking, adventure: adventure, user: user_2, completion_time: 6720)
    insert(:ranking, adventure: adventure, user: user_1, completion_time: 6840)
    [adventure: adventure, user_1: user_1, user_2: user_2, user_3: user_3, user_4: user_4, user_5: user_5, user_6: user_6]
  end

  test "return ranking - limit 10, one page", %{
    conn: conn,
    adventure: adventure,
    user_1: user_1,
    user_2: user_2,
    ...
    assert result = [
             %{position: 1, user_id: user_1.id},
             %{position: 2, user_id: user_5.id},
             %{position: 3, user_id: user_4.id},
             %{position: 4, user_id: user_6.id},
             %{position: 5, user_id: user_3.id},
             %{position: 6, user_id: user_2.id}
           ]
  end
